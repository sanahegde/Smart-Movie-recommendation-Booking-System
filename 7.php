...
<body style="background-image: linear-gradient(to top, #96fbc4 0%, #f9f586 100%);">
 ...
 <div style="width: 100%;margin-top: 5px; font-family: Consolas" align="left">
   ...
   <p style="width: 50%" align="left">
     <label>
       ...
       paypal</label>
       <button><script src="https://www.paypal.com/sdk/js?client-id=sb"></script>
<script>paypal.Buttons().render('body');</script></button>
     <br>
     <label>
