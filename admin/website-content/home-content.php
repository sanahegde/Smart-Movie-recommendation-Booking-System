...
?>
	...
	<div class="row">
			  ...
			  <div class="form-group">
            	...
            	<select class="form-control" name="content_section">
                   ...
                   switch (strtolower($contentSection)) {
                          ...
                          ?>
                     <option value="how to download" selected>Home</option>
            		<option value="about downloader">Quiz</option>
            		<option value="downloader features">Recommendations</option>
            		<option value="downloader details">Logout</option>
            		...
            		<option value="downloader details">Upcoming</option>
                           <?php
                          break;
                          case 'downloader Now showing':
                           ?>
                     <option value="how to download">How to Download</option>
            		<option value="about downloader">Now showing</option>
		...
		<div class="col">
			<div class="form-group">
				<input type="text" class="form-control"  placeholder="Movie Page Title (h1)" name="first_title" value="<?php echo $firstTitle; ?>">
			</div>
		</div>
		<div class="col">
			<div class="form-group">
				<input type="text" class="form-control"  placeholder="Movie Page Recommendation (h2)" name="second_title" value="<?php echo $secondTitle; ?>">
			</div>
		</div>
	</div>
	<div class="row">
   ...
   while($data=$res1->fetch_assoc()){
   	...
   	<tr>
        ...
        <td><a href="javascript:void(0)" class="text-danger delete"  name="home_content" id="<?php echo $data['id']; ?>"><i class='far fa-trash-alt'></i></a></td>
         <td><a href="payment.php">View payment details</a>
   	</tr>
   	<?php
   $i++;}
}else{
